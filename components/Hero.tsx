  ...
  return (
    <section className="flex flex-col items-center justify-center pt-[106px] text-white desktop:pt-0">
      <div className="flex w-[320px] flex-col desktop:w-full">
        <h1 className="mb-[14px] mt-[92px] flex flex-col text-center font-overpass text-4xl font-medium leading-[46px] desktop:mb-[32px] desktop:mt-[98px] desktop:text-[64px]">
      ...
      <div className="mt-11 flex gap-4 font-ubuntu font-extrabold desktop:mt-[46px]">
        <a
          href="#"
